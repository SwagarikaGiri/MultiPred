...
@ck.option(
    '--filename',
    default= 'ResultSequenceStruct.txt',
...
def load_data(org=None):
    ...
    train = get_values(train_df[0:100])
    valid = get_values(valid_df[0:100])
    test = get_values(test_df[0:100])

    return train,valid,test,train_df[0:100],valid_df[0:100],test_df[0:100]
