...
@ck.option(
    '--filename',
    default= 'UnimodalResultSequence.txt',
...
def load_data(org=None):
    ...
    df = pd.read_pickle(DATA_ROOT + 'unimodal_seq_train' + '-' + FUNCTION + '.pkl')

    test_df = pd.read_pickle(DATA_ROOT + 'unimodal_seq_test' + '-' + FUNCTION + '.pkl')
